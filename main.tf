...
data github_branch "source_branch" {
  provider   = github.public_repo
  repository = var.public_repo.name
  branch     = data.github_repository.public_repo.default_branch != null ? data.github_repository.public_repo.default_branch : "main"
}
...
#   repository = var.public_repo.name
#   recursive  = true
#   tree_sha   = data.github_branch.source_branch.sha
# }
